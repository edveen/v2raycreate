...
install_v2-ui() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/v2-ui-linux.tar.gz https://git.haoduck.cf/github.com/sprov065/v2-ui/releases/download/${last_version}/v2-ui-linux.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://git.haoduck.cf/github.com/sprov065/v2-ui/releases/download/${last_version}/v2-ui-linux.tar.gz"
